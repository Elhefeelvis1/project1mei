...
const Home = () => {
  ...
  const handleAdminDashboard = (e) => {
    ...
    if (user?.role === 'administrator') {
      ...
      showToast('error', "Access Denied: User is not an Admin");
    }
  };
  ...
  return (
    <>
      ...
      <div className='absolute bottom-4 w-[calc(100%-19rem)] flex items-center justify-center'>
        <p className='text-slate-900 text-md font-semibold font-mono'>-- Developed By Elvis 08149476348 --</p>
      </div>
    </>
  );
};
