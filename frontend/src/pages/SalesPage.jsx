                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <div className='flex align-center w-full'>
                      ...
                      />
                      <button onClick={handleCustomerSearch} className="w-[20%] px-3 py-2 text-white bg-indigo-600 hover:bg-indigo-700 rounded-r-xl shadow-sm cursor-pointer">
                        <Search size={16} />
                      </button>
                    </div>
                  </div>
                  {customerName && customerName !== "Walk in customer" && (
                    <button
                      ...
                      className="flex justify-center align-center gap-2 w-full mt-3 px-3 py-2 bg-indigo-50 text-indigo-700 border border-indigo-200 hover:bg-indigo-100 rounded-lg transition text-sm font-medium shadow-sm cursor-pointer"
                    >
                      <StickyNote size={16} />
                      Notes
                    </button>
